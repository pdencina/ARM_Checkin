...
export interface Service {
  id: string; nombre: string; fecha: string; hora: string | null; activo: boolean; created_at: string;
}
export interface Checkin {
  id: string; child_id: string; service_id: string; checkin_guardian_id: string;
  checkout_guardian_id: string | null; codigo_seguridad: string;
  estado: "checked_in" | "checked_out"; checkin_at: string; checkout_at: string | null;
}
